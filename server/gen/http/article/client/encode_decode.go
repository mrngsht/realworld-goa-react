...
// set to call the "article" service "update" endpoint
func (c *Client) BuildUpdateRequest(ctx context.Context, v any) (*http.Request, error) {
	var (
		articleID string
	)
	{
		p, ok := v.(*article.UpdatePayload)
		if !ok {
			return nil, goahttp.ErrInvalidType("article", "update", "*article.UpdatePayload", v)
		}
		articleID = p.ArticleID
	}
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: UpdateArticlePath(articleID)}
	req, err := http.NewRequest("POST", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("article", "update", u.String(), err)
	}
	if ctx != nil {
		req = req.WithContext(ctx)
	}
...
// EncodeUpdateRequest returns an encoder for requests sent to the article
// update server.
func EncodeUpdateRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*article.UpdatePayload)
		if !ok {
			return goahttp.ErrInvalidType("article", "update", "*article.UpdatePayload", v)
		}
		body := NewUpdateRequestBody(p)
		if err := encoder(req).Encode(&body); err != nil {
			return goahttp.ErrEncodingError("article", "update", err)
		}
		return nil
	}
}

// DecodeUpdateResponse returns a decoder for responses returned by the article
// update endpoint. restoreBody controls whether the response body should be
// restored after having been read.
// DecodeUpdateResponse may return the following errors:
//   - "ArticleUpdateArticleBadRequest" (type *article.ArticleUpdateArticleBadRequest): http.StatusBadRequest
//   - error: internal error
func DecodeUpdateResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusOK:
			...
			err = decoder(resp).Decode(&body)
			if err != nil {
				return nil, goahttp.ErrDecodingError("article", "update", err)
			}
			err = ValidateUpdateResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("article", "update", err)
			}
		...
		case http.StatusBadRequest:
			...
			err = ValidateUpdateArticleUpdateArticleBadRequestResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("article", "update", err)
			}
			return nil, NewUpdateArticleUpdateArticleBadRequest(&body)
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("article", "update", resp.StatusCode, string(body))
		}
	}
}

// BuildDeleteRequest instantiates a HTTP request object with method and path
// set to call the "article" service "delete" endpoint
func (c *Client) BuildDeleteRequest(ctx context.Context, v any) (*http.Request, error) {
	var (
		articleID string
	)
	{
		p, ok := v.(*article.DeletePayload)
		if !ok {
			return nil, goahttp.ErrInvalidType("article", "delete", "*article.DeletePayload", v)
		}
		articleID = p.ArticleID
	}
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: DeleteArticlePath(articleID)}
	req, err := http.NewRequest("POST", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("article", "delete", u.String(), err)
	}
	if ctx != nil {
		req = req.WithContext(ctx)
	}
...
// EncodeDeleteRequest returns an encoder for requests sent to the article
// delete server.
func EncodeDeleteRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*article.DeletePayload)
		if !ok {
			return goahttp.ErrInvalidType("article", "delete", "*article.DeletePayload", v)
		}
		body := NewDeleteRequestBody(p)
		if err := encoder(req).Encode(&body); err != nil {
			return goahttp.ErrEncodingError("article", "delete", err)
		}
		return nil
	}
}

// DecodeDeleteResponse returns a decoder for responses returned by the article
// delete endpoint. restoreBody controls whether the response body should be
// restored after having been read.
// DecodeDeleteResponse may return the following errors:
//   - "ArticleDeleteArticleBadRequest" (type *article.ArticleDeleteArticleBadRequest): http.StatusBadRequest
//   - error: internal error
func DecodeDeleteResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusBadRequest:
			...
			err = decoder(resp).Decode(&body)
			if err != nil {
				return nil, goahttp.ErrDecodingError("article", "delete", err)
			}
			err = ValidateDeleteArticleDeleteArticleBadRequestResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("article", "delete", err)
			}
			return nil, NewDeleteArticleDeleteArticleBadRequest(&body)
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("article", "delete", resp.StatusCode, string(body))
		}
	}
}
