...
// List returns an endpoint that makes HTTP requests to the article service
// list server.
...
// GetComments returns an endpoint that makes HTTP requests to the article
// service getComments server.
